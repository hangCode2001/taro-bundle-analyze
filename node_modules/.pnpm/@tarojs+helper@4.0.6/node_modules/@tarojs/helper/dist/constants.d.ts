...
export declare const taroJsMiniComponentsPath = "@tarojs/components/mini";
...
export declare const DEFAULT_TEMPLATE_SRC = "github:NervJS/taro-project-templates#v4.0";
export declare const DEFAULT_TEMPLATE_SRC_GITEE = "direct:https://gitee.com/o2team/taro-project-templates.git#v4.0";
export declare const TARO_CONFIG_FOLDER = ".taro4.0";
